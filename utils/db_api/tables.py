...
logs_bot_running = """
CREATE TABLE IF NOT EXISTS logs_bot_running (
...
logs_button_clicks = """
CREATE TABLE IF NOT EXISTS logs_button_clicks (
    id SERIAL PRIMARY KEY,
    date TIMESTAMP,
    tg_id BIGINT,
    chat_id BIGINT,
...
logs_status_changes = """
CREATE TABLE IF NOT EXISTS logs_status_changes (
    id SERIAL PRIMARY KEY,
    date TIMESTAMP,
    status TEXT,
...
employee_stat = """
CREATE TABLE IF NOT EXISTS employee_stat (
...
customer_stat = """
CREATE TABLE IF NOT EXISTS customer_stat (
...
fsm = """
CREATE TABLE IF NOT EXISTS finite_state_machine (
    tg_id BIGINT PRIMARY KEY,
    message_id BIGINT,
    chat_id BIGINT,
    text TEXT,
